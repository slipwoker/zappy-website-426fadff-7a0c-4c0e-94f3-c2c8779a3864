    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "מטבח מתקפל לג'יפ משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '426fadff-7a0c-4c0e-94f3-c2c8779a3864',
                    name: data.name || '',
                    email: data.email || '',
